...
LineSegment[] CHECKPOINTS = {
  ...
  new LineSegment(new Vec2f(713.0, 245.0), new Vec2f(577.0, 407.0)) // Final checkpoint in the same position as the first
                                                                    // So that the car will know it has completed a full lap
                                                                    // when crossing this checkpoint.
};
