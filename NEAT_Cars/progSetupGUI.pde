...
public void createGUI(){
  ...
  label1 = new GLabel(progSetupWin, 9, 186, 369, 20);
  ...
  xmlFile_tf = new GTextField(progSetupWin, 11, 122, 207, 17, G4P.SCROLLBARS_NONE);
  xmlFile_tf.setPromptText("Pretrained Genome XML File...");
